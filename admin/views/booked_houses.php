...
<div class="container-fluid">
  ...
  <div class="row">
<?php
if($category=='admin'): $query = $db->getRows('houses',array('where'=>array('status'=>1)));
elseif($category=='house_owner'): $query = $db->getRows('houses',array('where'=>array('status'=>1, 'house_owner_id'=>$id)));
endif;
        ...
        <div class="collapse show" id="collapseCardExample1">
          <div class="card-body">
             ...
             <div class="">
               ...
               <a href="../single_list.php?request=<?php echo $show['id'];?>&status=booked" style="border-radius: 0px;"  class="btn btn-primary" name="button">More Info</a>
             </div>
          </div>
        </div>
      </div>
